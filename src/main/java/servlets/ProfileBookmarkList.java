...
/**
 * Servlet implementation class ProfileBookmarkList
 */
@WebServlet("/ProfileBookmarkList")
public class ProfileBookmarkList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProfileBookmarkList() {
        super();
